...
How to process or visualize these requests?? The most important data is hidden behind layers of encoding and the
response is mostly for machines to consume. In this case, write up a script to extract and decode relevant parts of
data. Do this once and all the requests will follow your transforms and be saved to files in the beautified modes.
